...
// Standard normal CDF via erf (Abramowitz-Stegun 7.1.26): N(x) = 0.5·(1 + erf(x/√2)).
// NOTA: la versione precedente applicava i coefficienti di erf direttamente a x con exp(−x²/2),
// senza riscalare l'argomento per √2 — errore fino a ±0.037 di probabilità. Corretta il 2026-07-07.
